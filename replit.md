...
- `leads` — CRM leads (anunciante/restaurante types, kanban stages, CNPJ/address fields, convertedToId/convertedToType for tracking conversions, opportunityType new/upsell, revenueType mrr/oneshot)
