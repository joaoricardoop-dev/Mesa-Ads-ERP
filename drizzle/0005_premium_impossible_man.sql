...
ALTER TABLE "contacts" ADD CONSTRAINT "contacts_restaurantId_active_restaurants_id_fk" FOREIGN KEY ("restaurantId") REFERENCES "public"."active_restaurants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
