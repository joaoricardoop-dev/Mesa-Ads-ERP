...
const clerkAppearance = {
  ...
  elements: {
    rootBox: "mx-auto",
    logoBox: "hidden",
    card: "bg-[#fbfaf7] border border-black/10 shadow-2xl rounded-2xl",
    headerTitle:
      "text-[#1a1a17] font-display tracking-tight text-2xl font-semibold",
    headerSubtitle: "text-[#5c5c57] text-sm",
    formFieldLabel:
      "text-[#5c5c57] label-mono text-[10px] tracking-[0.18em]",
    formFieldInput:
      "bg-white border-black/15 text-[#1a1a17] placeholder:text-[#9a9a93] rounded-lg focus:border-[#00c238]/70 focus:ring-1 focus:ring-[#00c238]/40",
    formButtonPrimary:
      "bg-[#00c238] hover:bg-[#00a830] text-[#040405] font-semibold tracking-tight rounded-lg shadow-[0_0_0_1px_rgba(0,194,56,0.4)] transition-all",
    footer: "hidden",
    footerAction: "hidden",
    footerActionLink: "hidden",
    socialButtonsBlockButton:
      "border-black/15 bg-black/[0.02] text-[#1a1a17] hover:bg-black/[0.05] rounded-lg",
    socialButtonsBlockButtonText: "text-[#1a1a17] font-medium",
    dividerLine: "bg-black/12",
    dividerText: "text-[#5c5c57] label-mono text-[10px]",
    identityPreview: "bg-white border-black/15 rounded-lg",
    identityPreviewText: "text-[#1a1a17]",
    identityPreviewEditButton: "text-[#00a830] hover:text-[#00c238]",
    formFieldInputShowPasswordButton: "text-[#5c5c57] hover:text-[#1a1a17]",
    otpCodeFieldInput:
      "bg-white border-black/15 text-[#1a1a17] rounded-lg focus:border-[#00c238]/70",
  },
};
